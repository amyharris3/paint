...
void SDLRenderer::switchRenderTarget(RenderTarget target)
{
...
void SDLRenderer::renderBox(RenderTarget target, gfx::Rectangle rect, gfx::Colour colour)
{
...
void SDLRenderer::renderTextbox(RenderTarget target, gfx::Rectangle rect, gfx::Colour colour, gfx::Text* text, const int xOffset, const int yOffset)
{
	switchRenderTarget(target);
...
void SDLRenderer::renderText(RenderTarget target, gfx::Text* text, int const xPixel, int const yPixel)
{
	switchRenderTarget(target);
...
void SDLRenderer::renderLines(RenderTarget target, const std::vector<gfx::Line>& lines, const int thickness, const uint8_t drawRGBA_[])
{
	switchRenderTarget(target);
