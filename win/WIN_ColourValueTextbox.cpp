...
ColourValueTextbox::ColourValueTextbox(const gfx::Rectangle rect, const char* name, gfx::Renderer* renderer, int const textSize, int const xOffset, int const yOffset, uint8_t* linkedVariablePrimary, uint8_t* linkedVariableSecondary, const bool primaryActive)
...
bool ColourValueTextbox::mouseButtonUp(MouseButton button, bool clicked)
{
	if (getClick()) {
